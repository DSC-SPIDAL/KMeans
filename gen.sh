...
mkdir -p /home/supun/dev/projects/dsspidal/KMeans/data/$n-$d-$k
java -cp $cp org.saliya.ompi.kmeans.DataGenerator -n $n -d $d -k $k -o /home/supun/dev/projects/dsspidal/KMeans/data/$n-$d-$k -b false -t true
