...
i=/N/u/sekanaya/sali/git/github/esaliya/java/KMeans/points.bin
n=1000000
d=2
b=true
o=/N/u/sekanaya/sali/git/github/esaliya/java/KMeans/
x=2
java -cp $cp org.saliya.ompi.kmeans.DataDuplicator -i $i -n $n -d $d -o $o -b $b -x $x
