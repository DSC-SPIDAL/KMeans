...
list.cmd.sh $nodefile "rm -rf /dev/shm/$USER/*.bin"
list.cmd.sh $nodefile "rm -rf /dev/shm/*.bin"
./run.generic.sh 3 8 $nodefile $nodes 3 g $explicitbind $procbind
list.cmd.sh $nodefile "rm -rf /dev/shm/$USER/*.bin"
list.cmd.sh $nodefile "rm -rf /dev/shm/*.bin"
./run.generic.sh 4 6 $nodefile $nodes 4 g $explicitbind $procbind
list.cmd.sh $nodefile "rm -rf /dev/shm/$USER/*.bin"
list.cmd.sh $nodefile "rm -rf /dev/shm/*.bin"
./run.generic.sh 6 4 $nodefile $nodes 6 g $explicitbind $procbind
list.cmd.sh $nodefile "rm -rf /dev/shm/$USER/*.bin"
list.cmd.sh $nodefile "rm -rf /dev/shm/*.bin"
./run.generic.sh 8 3 $nodefile $nodes 8 g $explicitbind $procbind
list.cmd.sh $nodefile "rm -rf /dev/shm/$USER/*.bin"
list.cmd.sh $nodefile "rm -rf /dev/shm/*.bin"
